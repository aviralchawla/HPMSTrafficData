...
def download_census_counties_data(year: int, tiger_url: str, storage_dir: Path):
    ...
    download_file(tiger_counties_url, census_counties_storage_dir / f'tl_{year}_us_county.zip')
...
def download_census_urban_areas_data(year: int, tiger_url: str, storage_dir: Path):
    ...
    download_file(tiger_urban_areas_url, census_urban_areas_storage_dir / f'tl_{year}_us_uac10.zip')
    unzip_file(f'tl_{year}_us_uac10.zip', census_urban_areas_storage_dir)

    print(f"Census Urban Areas Data downloaded and saved to {census_urban_areas_storage_dir}")
