...
results_hdv_perturb_df = pd.DataFrame(results_hdv_perturb)
results_hdv_perturb_df.to_csv(f'../../data/results/sensitivity_results_HDV_perturb_{run}.csv', index = False)