...
#                                                                             #
# Approximate total execution time: --- 1 hour --- (02/19/2024)               #
#                                                                             #
############################## ABOUT THIS SCRIPT ##############################
...
try:
    ...
    arcpy.MakeFeatureLayer_management(fc, feature_layer_name)
